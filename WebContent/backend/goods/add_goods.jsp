...
<div>
		...
		<div>
			...
			<input type="text" name="price" id="price" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
...
<c:if test="${login_user.role.id eq '2'}">
		...
		<div>
			...
			<input type="text" name="nums" id="nums" value="" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div class="enter">
