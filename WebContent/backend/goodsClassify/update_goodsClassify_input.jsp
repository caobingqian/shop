...
<body>
<div id="formwrapper">
	<h3 class="add_title1">编辑商品分类</h3>
	<form action="goodsClassify!update?pageNo=${page.pageNo }&pageSize=${page.pageSize }" method="post">
	<input type="hidden" name="id" value="${goodsClassify.id }">

	<fieldset>
		<legend class="add_title2">商品分类信息</legend>
		<div>
			<label for="name">分类名称</label>
			<input type="text" name="name" id="name" value="${goodsClassify.name }" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="descp">备注</label>
			<input type="text" name="descp" id="descp" value="${goodsClassify.descp }" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div class="enter">
