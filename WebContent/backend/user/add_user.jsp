<%@ page language="java" import="org.bs.ssh.model.*,java.util.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
...
<div id="formwrapper">
	...
	<fieldset>
		...
		<div>
			...
			<input type="text" name="no" id="no" value="" size="15" maxlength="15" onblur="v_no(this)"/> 
			<div  style="display: inline"><font id="validate_no" color="red"></font></div>
			<br />	
		</div>
		<div>
			<label for="college">学院</label>
			<select name="college" id="college" >
				<option value="软件学院"  selected="selected">软件学院</option>
		...
		<div>
			...
			<select name="classname" id="classname" >
				<option value="01班"  selected="selected">01班</option>
