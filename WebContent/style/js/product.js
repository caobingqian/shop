...
function strtotime(t, e) {
    ...
    function s(t) {
        ...
        o = "ago" === e[2],
        c = ("last" === s ? -1 : 1) * (o ? -1 : 1);
        if (n && (c *= parseInt(s, 10)), l.hasOwnProperty(a) && !e[1].match(/^mon(day|\.)?$/i)) return r["set" + l[a]](r["get" + l[a]]() + c);
    ...
    if (n = t.match(/^(\d{2,4})-(\d{2})-(\d{2})(?:\s(\d{1,2}):(\d{2})(?::\d{2})?)?(?:\.(\d+)?)?$/)) return o = n[1] >= 0 && 69 >= n[1] ? +n[1] + 2e3: n[1],
    new Date(o, parseInt(n[2], 10) - 1, n[3], n[4] || 0, n[5] || 0, n[6] || 0, n[7] || 0) / 1e3;
    ...
    p = "(years?|months?|weeks?|days?|hours?|minutes?|min|seconds?|sec|sunday|sun\\.?|monday|mon\\.?|tuesday|tue\\.?|wednesday|wed\\.?|thursday|thu\\.?|friday|fri\\.?|saturday|sat\\.?)", m = "([+-]?\\d+\\s" + p + "|" + "(last|next)\\s" + p + ")(\\sago)?", n = t.match(RegExp(m, "gi")), !n) return ! 1;
    for (u = 0, d = n.length; d > u; u++) if (!s(n[u])) return ! 1;
...
function mktime() {
    ...
    for (i = 0; s.length > i; i++) if (e[i] === void 0) e[i] = t["get" + s[i]](),
    e[i] += 3 === i;
    else if (e[i] = parseInt(e[i], 10), isNaN(e[i])) return ! 1;
    return e[5] += e[5] >= 0 ? 69 >= e[5] ? 2e3: 100 >= e[5] ? 1900 : 0 : 0,
    t.setFullYear(e[5], e[3] - 1, e[4]),
    t.setHours(e[0], e[1], e[2]),
    (t.getTime() / 1e3 >> 0) - (0 > t.getTime())
}
function monthDay(t, e) {
    ...
    u = "",
    h = 12 * (d - r) + p - c;
    return i = Math.floor(h / 12),
    s = h % 12,
    s = 0 === s - Math.floor(s) ? s + 1 : s,
    a = (mktime(0, 0, 0, p, m, d) - mktime(0, 0, 0, p, l, d)) / 86400,
    0 > a && (s -= 1),
    0 > s && (i -= 1),
    i > 0 && (u += i + "\u5e74"),
    s > 0 && (u += s + "\u4e2a\u6708"),
...
function showTip100(proobj) {
    ...
    fq_returnData && fq_formatData(fq_returnData),
    TipDiv.append($(proobj)),
    0 == $("#c04tip").length && $(document.body).prepend(TipDiv),
    $(proobj).show(),
    el_top_middle($("#c04tip"), 502, 358),
...
function getSuitInfoService(t) {
    if (null !== t.packResponseList && t.packResponseList.length > 0) {
        ...
        $("#favorable-suit").show(),
        $("#favorable-suit .mc").html(suit_TPL.tabs.process(t) + suit_TPL.cons.process(t)),
        ...
        function(t, e) {
            ...
            l = e.find(".infos .p-name a,.infos .btns a"),
            d = [G.sku];
            "" !== i && "" !== a && (o.html(parseFloat(i).toFixed(2)), r.html(parseFloat(a).toFixed(2)), c.html(parseFloat(n).toFixed(2))),
            e.find(".suits li[data-sku]").each(function() {
                d.push($(this).attr("data-sku"))
            }),
            l.attr("href", "http://www.jd.com/suit/show.html?suitId=" + s + "&skuIds=" + d.join(",")),
        ...
        $("#favorable-suit .scurr").trigger("click").trigger("mouseover"),
        G.removeLastAdd()
    }
}
...
function onlineService(t, e, i) {
    ...
    pageConfig.product.popInfo && pageConfig.product.popInfo.stock && (b.verderId = pageConfig.product.popInfo.stock.D.vid),
    open(v + decodeURIComponent($.param(b)), a, "status=no,toolbar=no,menubar=no,location=no,titlebar=no,resizable=yes,width=1018px,height=590")
}
    ...
    $.ajax({
        ...
        success: function(t) {
            if (t) {
                ...
                var i = t.seller,
                s = t.code;
                if (i && "" != i && (i = i.replace("&qt;", "'").replace("&dt;", '"')), 1 > $("#brand-bar-pop").length && ($("#j-im").length > 0 && $("#j-im").remove(), $("#summary-grade .dd #j-im").length > 0 && $("#summary-grade .dd #j-im").remove(), (1 == s || 2 == s || 3 == s || 9 == s) && $("#summary-grade .dd").append('<a id="j-im" class="djd-im" href="#none" clstag="shangpin|keycount|product|imbtn"><b>\u8054\u7cfb\u5ba2\u670d</b></a>')), 1 == s) $("#online-service").show(),
                $("#j-im").attr("title", i + " \u8054\u7cfb\u5ba2\u670d"),
                $("#j-im").click(function() {
...
function log(t, e) {
    ...
    o = o.replace(/\$type2\$/, escape(e)),
    o = o.replace(/\$data\$/, escape(s)),
    o = o.replace(/\$pin\$/, escape(a)),
    o = o.replace(/\$referrer\$/, escape(document.referrer)),
    o = o.replace(/\$jinfo\$/, escape("")),
    $.getJSON(o,
    function() {});
...
function CombineShare(t) {
    this.$el = t.$el,
    this.imgs = "string" == typeof t.imgs ? [t.imgs] : t.imgs,
    this.onbeforeOpen = t.onbeforeOpen ||
    function() {},
    t.title.length > 27 && (t.title = t.title.substr(0, 27) + "..."),
    this.shareParam = {
        sid: t.sid,
        rid: t.rid,
        title: t.title,
...
if (G === void 0) var G = window.G = {}; (function(t) {
            ...
            $.ajax({
                ...
                success: function(t) {
                    ...
                    for (var e = 0; t.length > e; e++) {
                        ...
                        r = parseFloat(t[e].p);
                        parseFloat(t[e].m),
                        r > 0 ? i.find("." + s + n).html("\uffe5" + t[e].p) : i.find("." + s + n).html("\u6682\u65e0\u62a5\u4ef7"),
                        "function" == typeof a && a(n, t[e], o)
                    }
                }
            })
        }
        ...
        $.ajax({
            ...
            success: function(t) {
                ...
                if (t && t.CommentsCount.length) {
                    ...
                    for (var n = 0; e > n; n++) $("." + i + t.CommentsCount[n].SkuId).find(".star").removeClass("sa5").addClass("sa" + t.CommentsCount[n].AverageScore),
                    $("." + i + t.CommentsCount[n].SkuId).html(s.replace("{NUM}", t.CommentsCount[n].CommentCount)),
                    a && a(t.CommentsCount[n].SkuId, t.CommentsCount[n])
                }
            }
        })
    },
    ...
    t.calculatePrice = function(t, e) {
        for (var i = $(t).parents(e), s = i.find(".master input").attr("wmeprice"), a = i.find("input:checked"), n = a.length, o = i.find(".infos .res-totalprice"), r = i.find(".infos .res-jdprice"), c = 0, l = 0, d = "http://cart.jd.com/cart/dynamic/reBuyForOrderCenter.action?wids={SKUS}&nums={NUMS}", p = i.find(".btn-buy,.J-buy-url"), m = [], u = 0; a.length > u; u++) c += parseFloat(a.eq(u).attr("wmaprice")),
        l += parseFloat(a.eq(u).attr("wmeprice")),
    ...
    t.getNewCLK = function(t, e) {
        ...
        t.csku && (s += "$csku=" + t.csku.join(",")),
        t.sku && (s += "$sku=" + t.sku),
        t.index !== void 0 && (s += "$index=" + t.index);
        var a = {
    ...
    t.showServiceDesc = function(t) {
        ...
        return i.test(s) && (e = "\u7531\u539f\u5382\u4e3a\u60a8\u63d0\u4f9b\u670d\u52a1\uff0c\u5b98\u65b9\u54c1\u8d28\u4fdd\u8bc1\uff0c\u670d\u52a1\u65e0\u5fe7"),
        i.test(a) && (e = "\u81ea\u5382\u5546\u4fdd\u4fee\u671f\u7ed3\u675f\u8d77\uff0c\u5ef6\u957f\u60a8\u7231\u673a\u7684\u4fdd\u4fee\u65f6\u95f4"),
        i.test(n) && (e = "\u63d0\u4f9b\u7531\u4e8e\u610f\u5916\u4e8b\u6545\u5bfc\u81f4\u7231\u673a\u6545\u969c\u7684\u4fdd\u4fee\u670d\u52a1"),
        i.test(o) && (e = "\u7231\u673a\u6545\u969c\u65e0\u9700\u7ef4\u4fee\uff0c\u76f4\u63a5\u514d\u8d39\u66f4\u6362\u65b0\u673a"),
        i.test(r) && (e = "\u4e13\u4e1a\u5de5\u7a0b\u5e08\u4e0a\u95e8\u4e3a\u60a8\u63d0\u4f9b\u5b89\u88c5\u8c03\u8bd5\u670d\u52a1"),
        i.test(s) && (e = "\u4e13\u5bb6\u5728\u7ebf\uff0c\u8fdc\u7a0b\u534f\u52a9\u60a8\u89e3\u51b3\u8f6f\u4ef6\u4f7f\u7528\u95ee\u9898"),
        i.test(c) && (e = "\u63d0\u4f9b1\u6b21\u5c4f\u5e55\u4fee\u590d\uff0c\u8ba9\u5c4f\u788e\u4e0d\u518d\u5fc3\u788e"),
        e
    },
    ...
    t.Countdown = {
        ...
        loopCount: function() {
            ...
            this.timer = setInterval(function() {
                ...
                0 === e.d && 0 === e.h && 0 === e.m && 0 === e.s ? clearInterval(t.timer) : t.seconds--,
                t.callback(e)
            },
            1e3)
        },
    ...
    t.onAttr = function(t, e) {
        ...
        if (i && i.length) {
            for (var s = 0; i.length > s; s++) if (i[s] == t) return e(),
            !0;
            return ! 1
        }
        return ! 1
...
pageConfig.serviceYB = "enabled",
pageConfig.btnBaiTiaoFq = "enabled",
function(t) {
    t.fn.floatNav = function(e) {
        ...
        s.parent().hasClass("float-nav-wrap") || s.wrap(o.css("height", a)),
...
function(t) {
    ...
    e.prototype = {
        ...
        onScroll: function() {
            ...
            a = t(window).height();
            e > i + this.opts.startThrehold && s - a - this.opts.stopThrehold > e ? this.opts.onStart(this) : this.opts.onEnd(this),
        ...
        t(this).hover(function() {
            ...
            t(document.body).mousemove(function(s) {
                ...
                if (isNaN(p) | isNaN(d)) {
                    ...
                    t("div.jqZoomPup").height(i.yzoom / (1 * d)),
                ...
                scrolly = ypos,
                t("div.zoomdiv").get(0).scrollTop = scrolly * d,
                scrollx = xpos,
...
Grecommend.prototype = {
    init: function() {
        ...
        this.uuid = t ? "-" == t.split(".")[1] ? -1 : t.split(".")[1] : -1,
        this.get(this.rid)
    },
    get: function(t) {
        var e = this,
    ...
    set: function(t) {
        function e(t, e) {
            ...
            for (var n = 0,
            o = 0; t.length > o; o++) 0 == o % e && n++,
            s[n - 1].tabs.push(t[o]),
            s[n - 1].increment = n,
            s[n - 1].skuids.push(t[o].wid);
            return s
        }
        function i() {
            pageConfig.product.cbCombineBuying = [pageConfig.product.skuid],
            a.attr("loaded", "true").html(suitRecommendNew_TPL.process(t)),
            log(G.mdPerfix + "3", "Show"),
            Recommend.switchTab("#th-hot"),
            G.removeLastAdd(),
            $("#tab-hot .master input").attr("skuid", pageConfig.product.skuid),
            G.getPriceNum(pageConfig.product.cbCombineBuying, readCookie("ipLoc-djd"), a, null,
            function(t, e) {
                a.find('input[skuid="' + t + '"]').attr("wmeprice", e.p),
                a.find('input[skuid="' + t + '"]').attr("wmaprice", e.m),
                G.calculatePrice($("#tab-hot .master input")[0], "#tab-hot")
            })
        }
        var s = this,
        a = s.el;
        if (pageConfig.product.GrecommendSkus = [], t.success && t.data && t.data.length > 0) {
            if (105e3 === this.rid && this.el.html(listBrosweBrosweNew_TPL.process(t)).parent().show(), 102004 === this.rid && this.el.html(listBrosweBrosweNew_TPL.process(t)).parent().show(), 103001 === this.rid && this.el.html(listBrosweBuyNew_TPL.process(t)).parent().show(), 102003 === this.rid && this.el.html(listBrosweBuyNew_TPL.process(t)).parent().show(), 103002 === this.rid && (this.el.html(listBuyBuyNew_TPL.process(t)).parent().show(), log(G.mdPerfix + "2", "Show")), 102002 === this.rid && this.el.html(listBuyBuyNew_TPL.process(t)).parent().show(), 102001 === this.rid && (1315 == G.cat[0] || 11729 == G.cat[0] ? (pageConfig.product.cbCombineBuying = [pageConfig.product.skuid], s.set1315(t)) : i()), 103003 === this.rid && i(), 902029 === this.rid && this.el.html(listBrosweBuyPOP_TPL.process(t)).parent().show(), (102001 === this.rid || 103003 === this.rid) && G.getPriceNum(pageConfig.product.GrecommendSkus, null, this.el), 303001 === this.rid && this.el.html(addToCart_TPL.process(t)).parent().show(), 103e3 === this.rid || 102e3 === this.rid) {
                this.el.html(noStock.process(t)),
                $("#out-of-stock").show();
            ...
            if (902011 === this.rid) {
                ...
                t.json = e(t.data, o),
                this.el.html(itemDisabled.process(t)),
                this.el.parents(".clearfix").eq(0).attr("data-widget", "tabs").Jtab({
                    compatible: !0,
                    auto: !0
                })
            }
            if (902018 === this.rid) {
                var a = $("#noitem-list");
                this.el.html(itemDisabledReco.process(t)),
                $("#out-of-stock").show();
                var n = pageConfig.wideVersion && pageConfig.compatible ? 5 : 4;
                a.imgScroll({
                    visible: n,
            ...
            G.getPriceNum(pageConfig.product.GrecommendSkus, readCookie("ipLoc-djd"), this.el),
    ...
    set1315: function(t) {
        ...
        c = {
            sClick: function(t, e) {
                ...
                i.click(function() {
                    ...
                    s.attr("data-res", [t, e, n, o, r].join("|"))
                }),
            ...
            get: function(t, e, i, s, a) {
                ...
                window.fetchJSON_sizeList = function(e) {
                    1 > e.Subcodesku.length ? (n.setTips('<p id="p-nostock">\u8be5\u5546\u54c1\u5df2\u4e0b\u67b6\u6216\u65e0\u8d27</p>'), $("#p-size").html("")) : 1 == e.Subcodesku.length && 0 == !!e.Subcodesku[0].sizename || "\u65e0" == e.Subcodesku[0].sizename ? (n.noSize(i, e), n.clearTips("#p-nostock")) : (n.set(e, t, i, s), n.clearTips("#p-nostock")),
        ...
        d = function(t) {
            ...
            function() {
                ...
                if (e.find("#p-scroll .curr").attr("title"), 1 > $("#pop-box .curr").length) c.setTips('<p id="p-noselected">\u8bf7\u9009\u62e9\u989c\u8272</p>');
                    ...
                    a.set(t, $("#pop-list-" + t).attr("data-res")),
                    r.hide().clear();
                    var i = $("#pop-list-" + t),
        ...
        if (t.success) {
            ...
            pageConfig.product.cbCombineBuyingPop = [],
            s.attr("loaded", "true").html(p.process(t)),
            ...
            $("#stabcon_pop ul input:checkbox").click(function() {
                ...
                if ("visible" == $("#pop-box").css("visibility")) {
                    ...
                    $("#pop-list-" + o).find("input:checkbox").attr("checked", !1),
                    r.clear().hide()
                }
            ...
            log(G.mdPerfix + "3", "Show"),
            Recommend.switchTab("#th-hot"),
            G.getPriceNum(pageConfig.product.cbCombineBuyingPop, null, s, null,
            function(t, e) {
                s.find('input[skuid="' + t + '"]').attr("wmeprice", e.p),
                s.find('input[skuid="' + t + '"]').attr("wmaprice", e.m)
            })
        }
    },
    setTrackCode: function(t) {
        ...
        e.each(function() {
            ...
            $(this).bind("click",
            function(e) {
                var a = $(e.target); (a.is("a") || a.is("img") || a.is("span")) && i.newImage(t + s, !0),
                a.is("input") && 1 == a.attr("checked") && i.newImage(t + s, !0)
            })
        }),
        this.newImage(t + s, !0)
    },
    newImage: function(t, e, i) {
        var s = new Image;
        t = e ? t + "&random=" + Math.random() + new Date: t,
        s.onload = function() {
            i !== void 0 && i(t)
        },
        s.setAttribute("src", t)
...
var Recommend = {
    ...
    renderRecoFittingsHTML: function() {
        ...
        return ! G.isJd && e ? !1 : (655 == G.cat[2] ? $.ajax({
            ...
            dataType: "script",
            cache: !0
        }) : $.getJSONP("http://d.360buy.com/fittingInfo/get?skuId=" + t + "&callback=Recommend.cbRecoFittings"), void 0)
    },
    cbNewFittings: function(t) {
        ...
        if (pageConfig.product.cbNewFittings = [pageConfig.product.skuid], pageConfig.setFittingsClk = function(t, e, i, s, a) {
            ...
            return 830 === G.cat[1] && (n.cid = "", n.mainSku = ""),
            n.rid = 830 === G.cat[1] ? 402002 : 402001,
            'clsClickLog("${cid}", "${mainSku}", "${itemSku}", ${id}, "${ind}", "${str}");G.clsLog(${rid}, "1", ${G.sku}, ${itemSku}, ${ind});'.process(n)
        },
        655 == G.cat[2] ? (clsPVAndShowLog("655", G.sku, 34, "p"), G.clsLog(402001, "0", G.sku, pageConfig.product.cbNewFittings.join(","))) : G.clsLog(402002, "0", G.sku, pageConfig.product.cbNewFittings.join(",")), t.accessoryByAccessList && (t.accessoryList = t.accessoryByAccessList, t.accessoryByAccessList = null), t && t.accessoryList && t.accessoryList.length > 0) {
            if (e.attr("loaded", "true").html(s.cons.process(t)), 830 != pageConfig.product.cat[1]) {
                for (var a = 0; t.accessoryList.length > a; a++) t.accessoryList[a].accessoryList.length = 4,
                t.accessoryList[a].accessoryList[0].thirdType = t.accessoryList[a].thirdTypeId,
                t.accessoryList[a].accessoryList[0].thirdName = t.accessoryList[a].thirdName,
                i.accessoryList.push(t.accessoryList[a].accessoryList[0]),
                i.isExtra = !1;
            ...
            function(t, i, a) {
                ...
                if (830 != G.cat[1]) if (c.attr("href", "http://rs.jd.com/accessorie/center.html?sku=" + G.sku + "&thirdTypeId=" + o).html("\u8fdb\u5165" + r), n.scrollLeft(0), 0 !== a) {
                    ...
                    window.fetchJSON_fittingExtra = function(t) {
                        ...
                        t.isExtra = !0,
                        t.accessoryList = t.accessoryList.slice(0, i),
                        $("#newFitting-" + a).html(s.item.process(t)).attr("loaded", "1"),
                        $("#newFitting-" + a).find(".hl_link").html("\u66f4\u591a" + $("#tab-cat-" + a).html());
                        try {
                            delete window.fetchJSON_fittingExtra
                        } catch(n) {}
                        G.getPriceNum(pageConfig.product.cbNewFittings, readCookie("ipLoc-djd"), e, null,
                        function(t, i) {
                            e.find('input[skuid="' + t + '"]').attr("wmeprice", i.p),
                            e.find('input[skuid="' + t + '"]').attr("wmaprice", i.m),
                            G.calculatePrice($("#tab-reco .master input")[0], "#tab-reco")
                        })
                    },
                    $.ajax({
            ...
            G.removeLastAdd(),
            $("#tab-reco .master input").attr("skuid", pageConfig.product.skuid),
            G.getPriceNum(pageConfig.product.cbNewFittings, readCookie("ipLoc-djd"), e, null,
            function(t, i) {
                e.find('input[skuid="' + t + '"]').attr("wmeprice", i.p),
                e.find('input[skuid="' + t + '"]').attr("wmaprice", i.m),
    ...
    renderHTML: function() {
        ...
        case 1:
            new Grecommend(G.sku, 103002, readCookie("ipLoc-djd"), $("#buy-buy .mc")),
            new Grecommend(G.sku, 103001, readCookie("ipLoc-djd"), $("#view-buy .mc")),
            new Grecommend(G.sku, 103003, readCookie("ipLoc-djd"), $("#tab-hot"));
            break;
        case 2:
            new Grecommend(G.sku, 102002, readCookie("ipLoc-djd"), $("#buy-buy .mc")),
            new Grecommend(G.sku, 102003, readCookie("ipLoc-djd"), $("#view-buy .mc")),
            1315 == G.cat[0] || 11729 == G.cat[0] ? new Grecommend(G.sku, 102001, readCookie("ipLoc-djd"), $("#tab-hot"), 12) : new Grecommend(G.sku, 102001, readCookie("ipLoc-djd"), $("#tab-hot"), 12);
            break;
        default:
        }
    },
    ...
    cbRecoFittings: function(t) {
        var e = $("#tab-reco");
        pageConfig.product.cbRecoFittings = [pageConfig.product.skuid],
        t && t.fittings && t.fittings.length > 0 && (e.attr("loaded", "true").html('<ul class="stab lh">' + recoFittings_TPL.tabs.process(t) + '</ul><div class="stabcon">' + recoFittings_TPL.cons.process(t) + "</div>"), this.switchTab("#th-fitting"), G.removeLastAdd(), G.getPriceNum(pageConfig.product.cbRecoFittings, readCookie("ipLoc-djd"), e, null,
        function(t, i) {
            e.find('input[skuid="' + t + '"]').attr("wmeprice", i.p),
            e.find('input[skuid="' + t + '"]').attr("wmaprice", i.m),
            G.calculatePrice($("#tab-reco .master input")[0], "#tab-reco", 1)
        }), G.getNewCLK({
            name: "tjpj",
            action: "0",
...
setAmount = {
    ...
    setBuyLink: function() {
        ...
        t.targetLink.each(function() {
            var e, i, s = $(this),
            a = s.attr("href"),
            n = a.split("?")[1]; (function() {
                for (var o = 0; t.matchCountKey.length > o; o++) if (i = RegExp(t.matchCountKey[o] + "=\\d+"), i.test(n)) return e = a.replace(i, t.matchCountKey[o] + "=" + t.count),
                s.attr("href", e),
                !1
            })()
        }),
        window.getPOPDeliveCash && getPOPDeliveCash(),
        onNumChange()
    }
};
...
var Refresh = {
    ...
    rFittings: function() {
        var t, e = $("#tab-reco");
        pageConfig.product.cbNewFittings !== void 0 && (t = pageConfig.product.cbNewFittings),
        pageConfig.product.fittingsAuto !== void 0 && (t = pageConfig.product.fittingsAuto),
        pageConfig.product.cbRecoFittings !== void 0 && (t = pageConfig.product.cbRecoFittings),
        t !== void 0 && t.length > 1 && (t.push(pageConfig.product.skuid), $("#recommend .master input").attr("skuid", pageConfig.product.skuid), G.getPriceNum(t, readCookie("ipLoc-djd"), null, null,
        function(t, i) {
            e.find('input[skuid="' + t + '"]').attr("wmeprice", i.p),
            e.find('input[skuid="' + t + '"]').attr("wmaprice", i.m),
            G.calculatePrice($("#tab-reco .master input")[0], "#tab-reco")
    ...
    rCombine: function() {
        var t = $("#tab-hot");
        pageConfig.product.cbCombineBuying !== void 0 && (pageConfig.product.cbCombineBuying.push(pageConfig.product.skuid), G.getPriceNum(pageConfig.product.cbCombineBuying, readCookie("ipLoc-djd"), null, null,
        function(e, i) {
            t.find('input[skuid="' + e + '"]').attr("wmeprice", i.p),
            t.find('input[skuid="' + e + '"]').attr("wmaprice", i.m),
            G.calculatePrice($("#tab-hot .master input")[0], "#tab-hot")
        }))
    }
},
CommentListNew = {
    ...
    bindReply: function() {
        var t = this;
        this.commList.find(".btn-toggle").unbind("click").bind("click",
        function() {
            var e = $(this),
            i = e.parents(".i-item"),
            s = e.attr("data-id");
            e.hasClass("btn-toggle") && $("#btn-toggle-" + t.type + "-" + s).toggle().find("input")[0].focus(),
            e.hasClass("btn-reply") && "true" === i.attr("data-top") && i.find(".hide-default").toggle()
        }),
        this.bindHover(),
        this.commList.find(".reply-btn").unbind("click").bind("click",
        function(e) {
            var i = $(e.target),
            s = i.attr("data-guid"),
    ...
    setReplyItem: function(t) {
        ...
        t.commentReply.index = e = c.length > 0 ? parseInt(c.attr("data-index"), 10) + 1 : 1,
        t.toname = r.attr("data-name"),
        t.touid = r.attr("data-uid"),
        o.length > 0 && (t.replyHTML = $("<div>").append(o.clone()).html());
        ...
        a.after($(l.process(t)).fadeIn()),
        s.find(".btns .btn-reply em").html(e),
        this.currReply.hasClass("reply-btn-lz") || this.currReply.parents(".replay-form").eq(0).hide(),
    ...
    getData: function(t, e, i, s) {
        ...
        this.url = this.url.replace("{skuId}", this.sku).replace("{commType}", this.type).replace("{sortType}", this.sType).replace("{currPage}", this.page),
        $.ajax({
            url: this.url,
            dataType: "jsonp",
            success: function(t) {
...
Discuss = {
    ...
    setDiscussComment: function(t) {
        ...
        e.html(i.process(t)),
        this.obj.find(".norecode").hide(),
        this.obj.find(".total span").html("\u5171" + (this.count + t.CommentCount) + "\u4e2a\u8bdd\u9898")
    }
},
Consult = {
    getData: function(t, e) {
        window.fetchJSON_Consult = function(t) {
            if (e.html(consult_TPL.process(t)), void 0 !== pageConfig.im) {
                ...
                s = i.code,
                a = i.seller;
                if (1 == s) $("#j-im-extra").css("display", "inline-block"),
                $("#j-im-extra").attr("title", a + " \u8054\u7cfb\u5ba2\u670d"),
                $("#j-im-extra").click(function() {
...
EvaluateGradeNew = {
    init: function(t) {
        var e = this;
        return e.popInfo = t,
        G.isJd ? !1 : (e.getGradeDetail(t.vid), e.getAddress(t.vid), e.setShopInfo(t), e.setGlobalBuy(t), void 0)
    },
    bindEvent: function() {
    ...
    calcTrends: function(t) {
        ...
        i = "",
        s = this.data;
        return 1 === t && (s.f20 === s.f35 && (e = "eva-eq"), s.f20 > s.f35 && (e = "eva-up", i = "\u8ba1\u7b97\u89c4\u5219\uff1a\uff08\u5546\u5bb6\u5f97\u5206-\u540c\u884c\u4e1a\u5e73\u5747\u5206\uff09/\uff08\u540c\u884c\u4e1a\u5546\u5bb6\u6700\u9ad8\u5f97\u5206-\u540c\u884c\u4e1a\u5e73\u5747\u5206\uff09"), s.f20 < s.f35 && (e = "eva-down", i = "\u8ba1\u7b97\u89c4\u5219\uff1a\uff08\u540c\u884c\u4e1a\u5e73\u5747\u5206-\u5546\u5bb6\u5f97\u5206\uff09/\uff08\u540c\u884c\u4e1a\u5e73\u5747\u5206-\u540c\u884c\u4e1a\u5546\u5bb6\u6700\u4f4e\u5f97\u5206\uff09")),
        2 === t && (s.f21 === s.f36 && (e = "eva-eq"), s.f21 > s.f36 && (e = "eva-up", i = "\u8ba1\u7b97\u89c4\u5219\uff1a\uff08\u5546\u5bb6\u5f97\u5206-\u540c\u884c\u4e1a\u5e73\u5747\u5206\uff09/\uff08\u540c\u884c\u4e1a\u5546\u5bb6\u6700\u9ad8\u5f97\u5206-\u540c\u884c\u4e1a\u5e73\u5747\u5206\uff09"), s.f21 < s.f36 && (e = "eva-down", i = "\u8ba1\u7b97\u89c4\u5219\uff1a\uff08\u540c\u884c\u4e1a\u5e73\u5747\u5206-\u5546\u5bb6\u5f97\u5206\uff09/\uff08\u540c\u884c\u4e1a\u5e73\u5747\u5206-\u540c\u884c\u4e1a\u5546\u5bb6\u6700\u4f4e\u5f97\u5206\uff09")),
        3 === t && (s.f22 === s.f37 && (e = "eva-eq"), s.f22 > s.f37 && (e = "eva-up", i = "\u8ba1\u7b97\u89c4\u5219\uff1a\uff08\u5546\u5bb6\u5f97\u5206-\u540c\u884c\u4e1a\u5e73\u5747\u5206\uff09/\uff08\u540c\u884c\u4e1a\u5546\u5bb6\u6700\u9ad8\u5f97\u5206-\u540c\u884c\u4e1a\u5e73\u5747\u5206\uff09"), s.f22 < s.f37 && (e = "eva-down", i = "\u8ba1\u7b97\u89c4\u5219\uff1a\uff08\u540c\u884c\u4e1a\u5e73\u5747\u5206-\u5546\u5bb6\u5f97\u5206\uff09/\uff08\u540c\u884c\u4e1a\u5e73\u5747\u5206-\u540c\u884c\u4e1a\u5546\u5bb6\u6700\u4f4e\u5f97\u5206\uff09")),
        {
            trends: e,
            title: i
        }
    ...
    setGradeDetail: function(t) {
        ...
        if (null !== t) {
            ...
            $("#evaluate").after(e.process(t)).find("dt").html("\u7efc\u5408\u8bc4\u5206\uff1a"),
            $(".evaluate-grade strong").html('<a href="' + i + '" target="_blank">' + t.f23.toFixed(10).substr(0, 3) + "</a>").attr("title", t.f23),
            $(".heart-red").removeClass("h5").addClass("h" + parseInt(t.f23)),
            pageConfig.product.isFlashPurchase && ($("#evaluate,#evaluate-detail,#enter-shop a").hide(), $("#seller dd").html($("#seller dd").text()))
        }
    },
    setShopInfo: function(t) {
        ...
        $("#enter-shop a").attr("href", t.url).attr("clstag", "shangpin|keycount|product|pop-01"),
        t.linkphone && "" == $("#hotline dd").html() && ($("#hotline dd").html(t.linkphone), $("#hotline").show())
    }
},
JdService = {
    init: function(t, e, i) {
        ...
        this.TPL = '<div class="service-type-yb">    {if r1.length>0}        <div class="yb-item-cat yb-item-cat-r1">            ${JdService.itemTPL.process(r1[0], [r1.length>1, 0])}            <div class="yb-item-hide">                {for item in r1}                    {if item_index!=0}${JdService.itemTPL.process(item, [r1.length>1])}{/if}                {/for}            </div>        </div>    {/if}    {if r2.length>0}        <div class="yb-item-cat yb-item-cat-r2">            ${JdService.itemTPL.process(r2[0], [r2.length>1, 0])}            <div class="yb-item-hide">                {for item in r2}                    {if item_index!=0}${JdService.itemTPL.process(item, [r2.length>1])}{/if}                {/for}            </div>        </div>    {/if}    {if r3.length>0}        <div class="yb-item-cat yb-item-cat-r3">            ${JdService.itemTPL.process(r3[0], [r3.length>1, 0])}            <div class="yb-item-hide">                {for item in r3}                    {if item_index!=0}${JdService.itemTPL.process(item, [r3.length>1])}{/if}                {/for}            </div>        </div>    {/if}    {if r4.length>0}        <div class="yb-item-cat yb-item-cat-r4">            ${JdService.itemTPL.process(r4[0], [r4.length>1, 0])}            <div class="yb-item-hide">                {for item in r4}                    {if item_index!=0}${JdService.itemTPL.process(item, [r4.length>1])}{/if}                {/for}            </div>        </div>    {/if}    {if r5.length>0}        <div class="yb-item-cat yb-item-cat-r5">            ${JdService.itemTPL.process(r5[0], [r5.length>1, 0])}            <div class="yb-item-hide">                {for item in r5}                    {if item_index!=0}${JdService.itemTPL.process(item, [r5.length>1])}{/if}                {/for}            </div>        </div>    {/if}    <div class="yb-item-cat yb-item-detail"><a class="hl_blue" target="_blank" href="http://sale.jd.com/act/1pChm0RcanBPYXIS.html?erpad_source=erpad">\u8be6\u60c5</a></div></div>',
        this.yb_TPL = '        <div class="service-type-yb">            {for data in list}            <div class="yb-item-cat ${data.cName}">                <div class="item">                    {if data.items.length > 1}<ins class="yb-item-more">\u66f4\u591a</ins>{/if}                    <b></b>                    <a class="yb-link" href="http://fuwu.jd.com" target="_blank"><i class="yb-ico"></i></a>                    <a href="#none" class="yb-item {if data.items.length > 1} yb-item-first{/if}" id="yb-pid-${data.items[0].platformPid}" data-type="${data.items[0].sortId}" data-sku="${data.items[0].platformPid}" title="${G.showServiceDesc(data.items[0].sortId)}">${data.items[0].sortName} \uffe5${data.items[0].price}</a>                </div>                {if data.items.length > 1}                <div class="yb-item-hide">                    {for yb in data.items}                    {if Number(yb_index)>0}                    <div class="item">                        <b></b>                        <a class="yb-link" href="http://fuwu.jd.com" target="_blank"><i class="yb-ico"></i></a>                        <a href="#none" class="yb-item" id="yb-pid-${yb.platformPid}" data-type="${yb.sortId}" data-sku="${yb.platformPid}" title="${G.showServiceDesc(yb.sortId)}">${yb.sortName} \uffe5${yb.price}</a>                    </div>                    {/if}                    {/for}                </div>                {/if}            </div>            {/for}            <div class="yb-item-cat yb-item-detail">                <a class="hl_blue" target="_blank" href="http://sale.jd.com/act/1pChm0RcanBPYXIS.html?erpad_source=erpad">\u8be6\u60c5</a>            </div>        </div>',
        this.get()
    },
    bindEvent: function() {
        var t = this;
        ...
        function() {
            ...
            s.hasClass("selected") ? s.removeClass("selected") : (a.find(".item").removeClass("selected"), s.addClass("selected")),
            t.currSku = i,
            t.currEl = e,
            t.calResult()
        })
    ...
    set: function(t) {
        ...
        for (e = 0; a > e; e++) i = RegExp("-" + t[e].sortId + "-"),
        i.test("-2-3-4-44-49-") ? (n.list[0] || (n.list[0] = {},
        n.list[0].items = [], n.list[0].cName = "yb-item-cat-r0"), n.list[0].items.push(t[e])) : i.test("-6-7-41-47--") ? (n.list[1] || (n.list[1] = {},
        n.list[1].items = [], n.list[1].cName = "yb-item-cat-r1"), n.list[1].items.push(t[e])) : i.test("-9-48-60-") ? (n.list[2] || (n.list[2] = {},
        n.list[2].items = [], n.list[2].cName = "yb-item-cat-r2"), n.list[2].items.push(t[e])) : i.test("-11-50-") ? (n.list[3] || (n.list[3] = {},
        n.list[3].items = [], n.list[3].cName = "yb-item-cat-r3"), n.list[3].items.push(t[e])) : i.test("-15-16-17-18-45-46-61-63-") ? (n.list[4] || (n.list[4] = {},
        n.list[4].items = [], n.list[4].cName = "yb-item-cat-r4"), n.list[4].items.push(t[e])) : i.test("-20-21-22-76-77-85-86-87-") ? (n.list[5] || (n.list[5] = {},
        n.list[5].items = [], n.list[5].cName = "yb-item-cat-r5"), n.list[5].items.push(t[e])) : i.test("-27-28-31-32-67-68-69-70-78-79-") ? (n.list[6] || (n.list[6] = {},
        n.list[6].items = [], n.list[6].cName = "yb-item-cat-r6"), n.list[6].items.push(t[e])) : i.test("-42-64-65-66-71-72-73-74-80-81-") ? (n.list[7] || (n.list[7] = {},
        n.list[7].items = [], n.list[7].cName = "yb-item-cat-r7"), n.list[7].items.push(t[e])) : i.test("-52-53-54-57-58-59-75-82-83-84-") ? (n.list[8] || (n.list[8] = {},
        n.list[8].items = [], n.list[8].cName = "yb-item-cat-r8"), n.list[8].items.push(t[e])) : (n.list[9] || (n.list[9] = {},
        n.list[9].items = [], n.list[9].cName = "yb-item-cat-r9"), n.list[9].items.push(t[e]));
        if (s.list.length > 0) {
            this.obj.html(this.yb_TPL.process(n)).parent().show(),
            pageConfig.product.hasYbInfo = !0;
        ...
        } else this.obj.parent().hide();
        this.bindEvent(),
        this.itemCount = s.list.length
    },
    addItem: function(t) {
        this.resObj["p" + t] = t
    },
...
NotifyPop = {
    ...
    init: function(t, e, i) {
        ...
        /from=weibo/.test(location.href) && (s = n.param.type, this.setThickBox(s, o)),
    ...
    setThickBox: function(t, e) {
        ...
        1 == t && (i = "\u964d\u4ef7\u901a\u77e5", s = this._saleNotify, a = 250),
        2 == t && (i = "\u5230\u8d27\u901a\u77e5", s = this._stockNotify, a = 210, n.storeAddressId = readCookie("ipLoc-djd")),
        s += e ? e: $.param(n),
        $.jdThickBox({
            type: "iframe",
...
CombineShare.prototype = {
    ...
    getThickBox: function(t, e) {
        ...
        var a = this,
        n = {};
        n.T1 = '<div id="cb-share1" class="combine-share">    <div class="mt">        <dl>            <dt class="fl">\u5206\u4eab\u5230\uff1a</dt>            <dd class="lh">{SHARELIST}</dd>        </dl>    </div>    <div class="mc">        <textarea id="share-text" name="" cols="30" rows="10" placeholder="\u8bf4\u70b9\u4ec0\u4e48\u5427...">{TEXT}</textarea>        <div class="share-meta clearfix">            <div class="share-link fl"><a class="s-btn s-btn-gray" href="{LINK}" target="_blank"><b class="s-btn"></b>\u5206\u4eab\u94fe\u63a5</a></div>            <div class="share-count lh ar">\u8fd8\u53ef\u4ee5\u8f93\u5165<em>100</em>\u5b57</div>        </div>        {IMGWRAP}    </div>    <div class="mb">        <div class="share-btn">            <a href="#none" class="s-btn s-btn-ok share-btn-ok">\u5206\u4eab</a>        </div>    </div></div>',
        n.T2 = '<div id="cb-share2" class="combine-share share-msg">    <dl>        <dd class="ld"><h5 class="ac"><strong><s class="share-ico"></s>\u6210\u529f\u5206\u4eab\u5230 {EXT}</strong></h5></dd>    </dl>    <div class="share-btn"><a href="#none" class="s-btn s-btn-gray" onclick="jdThickBoxclose();">\u786e\u5b9a</a></div></div>',
        n.T3 = '<div id="cb-share3" class="combine-share share-msg share-warning">    <dl>        <dt class="fl share-ico"></dt>        <dd class="ld"><h5>\u5206\u4eab\u5931\u8d25\uff0c\u8bf7\u91cd\u65b0\u64cd\u4f5c\u3002</h5></dd>    </dl>    <div class="share-btn"><a href="#none" class="s-btn s-btn-gray share-btn-fail">\u786e\u5b9a</a></div></div>',
        n.T4 = '<div id="cb-share4" class="combine-share share-msg share-warning">    <dl>        <dt class="fl share-ico"></dt>        <dd class="ld"><h5>\u5b57\u6570\u8d85\u51fa\u9650\u5236\u8bf7\u91cd\u65b0\u8f93\u5165</h5></dd>    </dl>    <div class="share-btn"><a href="#none" class="s-btn s-btn-gray share-btn-fail">\u786e\u5b9a</a></div></div>',
        n.T5 = '<div id="cb-share5" class="combine-share share-warning">    <dl>        <dt class="fl share-ico"></dt>        <dd class="ld"><h5>\u8bf7\u5148\u7ed1\u5b9a\u5206\u4eab\u5e73\u53f0\u8d26\u53f7\u518d\u8fdb\u884c\u5206\u4eab</h5></dd>    </dl>    <div class="share-btn"><a href="#none" class="s-btn s-btn-gray share-btn-rebind">\u786e\u5b9a</a></div></div>',
        n.IMG = '<p>\u9009\u62e9\u914d\u56fe\uff1a</p><div class="share-imgScroll">    <a id="share-img-prev" class="share-controls s-btn s-btn-gray" href="#none"><s></s></a>    <a id="share-img-next" class="share-controls s-btn s-btn-gray" href="#none"><s></s></a>    <div class="share-img-wrap">        <ul class="lh">{IMGS}</ul>    </div></div>',
        this.onbeforeOpen && this.onbeforeOpen(this);
        var o = i(),
        r = s(),
        c = "";
        c = o ? n["T" + t].replace("{IMGWRAP}", n.IMG).replace("{IMGS}", i()) : n["T" + t].replace("{IMGWRAP}", ""),
        c = c.replace("{LINK}", this.shareParam.url),
        c = c.replace("{SHARELIST}", r),
        this.textNumOverflow && (this.shareParam.content = this.cacheText),
        this.jp && (this.shareParam.content = this.shareParam.content.replace("{PRICE}", this.jp)),
        c = c.replace("{TEXT}", this.shareParam.content),
        e !== void 0 && (c = c.replace("{EXT}", e)),
        jdThickBoxclose && jdThickBoxclose(),
        1 === t && $.jdThickBox({
            title: "\u5206\u4eab\u7ed9\u597d\u53cb",
            width: 520,
            height: o ? 340 : 200,
        ...
        this.wrap = $("#cb-share" + t),
        1 === t && this.updateCount(),
        this.bindEvent()
    },
    bindEvent: function() {
        var t = this,
        ...
        e.find(".mt input").unbind("click").bind("click",
        function() {
            var e = $(this).val();
            $(this).next().hasClass("actived") || ($(this).next().addClass("actived"), window.open(t.shareMap["T" + e].url))
        }),
        e.find(".mc textarea").bind("keyup change",
        function() {
            t.updateCount($(this)),
            t.cacheText = $(this).val()
        }),
        i.bind("click",
        function() {
    ...
    updateCount: function(t) {
        ...
        a = s.find("em"),
        n = 100;
        0 > n - Math.ceil(i / 2) ? a.html("0") : a.html(n - Math.ceil(i / 2) + ""),
        Math.ceil(i / 2) > n ? s.addClass("overflow") : s.removeClass("overflow")
    },
    ...
    setBindStatus: function(t) {
        for (var e, i, s, a = 0; t.length > a; a++) e = t[a].name,
        i = t[a].status,
        s = t[a].type,
        1 === i && (this.wrap.find("#share-ico-" + e).addClass("actived"), this.wrap.find("#share-" + e).attr("checked", !0))
    },
    goShare: function() {
        var t = this,
...
G.onAttr("isOnlyIOUsPay",
function() {
    function t() { / debug / .test(location.href) && prompt("\u9875\u9762\u5c06\u8df3\u8f6c\u5230\uff1a", i.replace(/nums=\d+/, "nums=" + $("#buy-num").val()) + "&r=" + Math.random()),
        location.href = i.replace(/nums=\d+/, "nums=" + $("#buy-num").val()) + "&r=" + Math.random()
    }
    ...
    s.prepend(r),
    e = s.find("#choose-btn-baitiao"),
    a.remove(),
    n.hide(),
    o.addClass("nav-minicart-baitiao"),
    pageConfig.serviceYB = "disabled",
    pageConfig.btnBaiTiaoFq = "disabled",
    o.find("a").attr("href", "#none").addClass("btn-baitiao"),
    jdModelCallCenter.settings.fn = t,
    $(".btn-baitiao").click(function() {
        $(this).attr("href", "#none"),
        pageConfig.product.havestock && $.login({
            modal: !0,
            complete: function(e) {
...
function() {
    ...
    pageConfig.isOverseaPurchase = !0
}),
function() {
    function t() {
        var t = $("#choose-btn-easybuy,#choose-btn-baitiao-fq,#nav-minicart");
        pageConfig.product.specialAttrs.join("^"),
        $("#choose-btn-append,#choose-btn-qiang").addClass("disabled"),
        t.remove(),
        pageConfig.product.isWeChatStock = !0
    }
...
$(function() {
    ...
    function() {
        ...
        t.eq(0).attr("id", "p-con-detail"),
        t.eq(1).attr("id", "p-con-attr"),
        t.eq(2).attr("id", "p-con-list"),
        t.eq(3).attr("id", "p-con-comm"),
        t.eq(4).attr("id", "p-con-guar"),
        t.eq(5).attr("id", "p-con-wiki")
    } (),
    i.find("li").eq(0).attr("id", "th-fitting"),
    i.find("li").eq(1).attr("id", "th-hot"),
    i.find("li").eq(2).attr("id", "th-service").hide(),
    $("#th-fitting a").eq(0).text("\u63a8\u8350\u914d\u4ef6"),
    $("#summary-grade .dd a").attr("clstag", "shangpin|keycount|product|pingjiabtn"),
    $("#store-selector").attr("clstag", "shangpin|keycount|product|quyuxuanze"),
    $("#choose-btn-coll a").attr("clstag", "shangpin|keycount|product|btn-guanzhu"),
    $("#choose-btn-easybuy").attr("clstag", "shangpin|keycount|product|btn-easybuy"),
    ...
    1 > $("#th-dpg").length && ($("#th-service").before('<li data-widget="tab-item" class="none" id="th-dpg"><a href="javascript:;">\u76f8\u5173\u4e3b\u9898\u642d\u914d</a></li>'), $("#tab-services").before('<div id="tab-dpg" class="mc none" data-widget="tab-content"> <div class="iloading">\u6b63\u5728\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019...</div> </div>')),
    ...
    G.isJd && $("body").addClass("JD"),
    G.isPop && $("body").addClass("POP"),
    "" != $.trim($("#product-detail-6").html()) && ($("#p-con-wiki").show(), $("#practical-guide").Jtab({
        event: "click",
        hookKey: "data-subtab",
    ...
    /gift=true/.test(location.href) && ($("#choose-btns").prepend('<div id="choose-btn-gift" class="btn ' + s + '"><a href="' + a + '" class="btn-gift"><b></b>\u9009\u4f5c\u793c\u7269\u8d2d\u4e70</a></div>'), setAmount.targetLink = $("#choose-btn-append .btn-append,#choose-btn-gift .btn-gift")),
    (938747 == G.sku || 938749 == G.sku) && (t.addClass("disabled"), e.attr("href", "#none")),
    ...
    $("#view-bigimg").attr("clstag", "shangpin|keycount|product|chakandatu"),
    ...
    function(t) {
        ...
        if (t && t.CommentCount !== void 0) {
            ...
            i.html("(\u5df2\u6709" + t.CommentCount + "\u4eba\u8bc4\u4ef7)").css("float", "left"),
            t.CommentCount > 0 && s.find("a").append('<span class="hl_blue"> (' + t.CommentCount + ") </span>")
        } else e.removeClass("sa0").addClass("sa5"),
        i.html("(\u5df2\u67090\u4eba\u8bc4\u4ef7)").css("float", "left")
    }),
    function() {
        ...
        function(n) {
            ...
            r = $("#buy-num").val(),
            c = [],
            l = $("#choose-btn-qiang a");
            if (n.length > 0) {
                t.attr("href", e.replace(/pcount=\d+/, "pcount=" + r) + o),
                i.parent().show();
                for (var d = 0; n.length > d; d++) c.push("<strong>\u201c" + $("#yb-pid-" + n[d]).text() + "\u201d</strong>");
                i.html((s ? s + "\uff0c": "") + c.join("\uff0c"))
            } else t.attr("href", e.replace(/pcount=\d+/, "pcount=" + r)),
            i.html(s);
            l.length && !a && (a = l.attr("href")),
            l.length && (n.length > 0 ? l.attr("href", a + o) : l.attr("href", a))
        })
    } (),
    $(".jqzoom").jqueryzoom({
        xzoom: 400,
    ...
    G.isPop && $.getJSONP("http://st.3.cn/gvi.html?callback=setPopInfo&type=popdeliver&skuid=" + G.sku),
    ...
    c = function() {},
    l = function() {};
    if ($('#product-detail [data-widget="tab-item"]').find("a").addClass("toggle-link"),
    function() {
        function t(t) {
            var e = $(window).height(),
        ...
        return 1 > a.length ? !1 : (p.find("a").addClass("toggle-link"), o = function() {
            ...
            }), m.append('<ul class="hide sub-item">' + d.join("") + "</ul>"), e = m.children(), i = m.find("li"), m.find(".sub-item a").unbind("click").bind("click",
            function(t) {
                $(this).text();
                var e = $(this).attr("data-id"),
                s = e.replace("#detail-tag-id-", "");
                $("body,html").scrollTop($(e).offset().top - 35),
                i.remove("hl_red"),
                $(this).parent().addClass("hl_red"),
                log("skupage", "cateid", s, G.cat[2], G.cat[1], G.cat[0], G.sku, currentAreaInfo.currentProvinceName, currentAreaInfo.currentCityName),
                t.preventDefault(),
                t.stopPropagation()
            })), void 0)
        },
        n = function() {
            m.unbind("mouseover mouseenter mouseout").removeClass("hover"),
            m.children("a").html("\u5546\u54c1\u4ecb\u7ecd<s></s>"),
            pageConfig.detailListInited = !1
        },
        r = function() {
        ...
        o(), $("body").scroller({
            onScroll: function(e) {
                ...
                if (a.each(function() {
                    ...
                    i.filter('[data-id="detail-tag-id-' + n + '"]').addClass("hl_red")
    ...
    function() {
        ...
        var d = new pageConfig.FN_InitSidebar,
        p = "98523";
    ...
    if (setImButton(G.sku), 1319 === G.cat[0] && $.ajax({
        ...
        } else m = RegExp(searchEngineSource.d).test("soso#sogou") ? "&encode=gbk": "&encode=utf-8";
        pageConfig.disabledSeoBanner = !0,
        seoBanner(searchEngineSource, m)
    } (function() {
        var t = ["2_163_817", "2_163_818", "2_232_3431", "2_163_3743"];
        pageConfig.disabledSeoBanner || (t.push("2_163_5395"), t.push("2_163_5394")),
        1315 === G.cat[0] && $("#Ad2_100_2272").length > 0 && t.push("2_100_2272"),
        G.isPop && t.push("2_601_3951"),
        $.ajax({
    ...
    clsPVAndShowLog("", "", 3, "p"),
    clsPVAndShowLog("", "", 2, "p"),
    $("#choose-btn-append .btn-append b").livequery("click",
    function() {
    ...
    function() {
        ...
        if (t && 1 > i.length) {
            ...
            e.before('<div id="letv"><iframe id="le-video" data-lazyload="' + s + '" frameborder="0" scrolling="no" style="display:block; width:750px; height:422px; margin:0 auto;"></iframe></div>'),
            $("#letv iframe").Jlazyload({
                type: "image"
            })
        }
    } (),
    function() {
        ...
        if ("undefined" != typeof warestatus && 0 === warestatus) {
            ...
            $("#product-intro").parent().after(i),
            new Grecommend(G.sku, 902011, readCookie("ipLoc-djd"), t, e),
            new Grecommend(G.sku, 902018, readCookie("ipLoc-djd"), $("#out-of-stock #noitem-list"), 20)
        }
    } (),
    function() {
    ...
    function() {
        ...
        G.isJd && (s += '            <div class="consult-pub">                <a class="css3-btn" target="_blank" href="http://club.jd.com/allconsultations/' + G.sku + '-1-1.html#form1">\u53d1\u8868\u54a8\u8be2</a>            </div>'),
        t.remove(),
        e.addClass("consult-2014"),
        e.find(".mt").append(s),
        window.closeCounsultSearch = function() {
            $("#consult-wrap").removeClass("hover"),
            pageConfig.onConsultSearch = !1
        },
...
MBuy = {
    init: function() {
        this.chooseBtn = $("#choose-btns"),
        pageConfig.isOverseaPurchase || this.setQrcode()
    },
    setQrcode: function() {
        var t = this,
    ...
    setProm: function(t) {
        ...
        if (! (t && t.indexOf(".") > -1)) return this.mt.html("\u5ba2\u6237\u7aef\u9996\u6b21\u4e0b\u5355"),
        e.html('<strong class="hl_red">\u90015\u5143\u4eac\u5238</strong>'),
        void 0;
        t = t.split(",");
        var i = isNaN(Number(t[1])) ? 0 : Number(t[1]) / 1e3;
        Math.floor(i / 86400) > 7 ? (this.mt.html("\u5ba2\u6237\u7aef\u9996\u6b21\u4e0b\u5355"), e.html('<strong class="hl_red">\u90015\u5143\u4eac\u5238</strong>')) : (this.mt.html('<strong class="hl_red">\u624b\u673a\u4e13\u4eab\u4ef7\uff1a' + t[0] + "\u5143</strong>"), i >= 0 && G.Countdown.init(i,
        function(t) {
    ...
    t.test(e) ? MBuy.setProm = function() {}: MBuy.init()
})();
...
ABTest.prototype = {
    ...
    isHitVersion: function(t) {
        ...
        t ? (e = this.getHashProbability(t, this.base), i > e ? (this.version.A++, this.result.A.push(t), "A") : e >= i && 2 * i > e ? (this.version.B++, this.result.B.push(t), "B") : (this.version.N++, this.result.N.push(t), "NONE")) : (version.N++, this.result.N.push(t), "NONE")
    },
    switchVersion: function(t) {
        if (!t || !/A|B|N/.test(t)) return 0,
        !1;
        this.tested || 0;
        var e = this.result[t],
        i = e[Math.floor(Math.random() * e.length)];
        createCookie("__jda", "122270672." + i + ".043878.1386043878.1386043878.1", 10, "/;domain=jd.com"),
        0
    },
    getHashProbability: function(t, e) {
        function i(t) {
            for (var e = 0,
            i = 0; t.length > i; i++) e = (e << 5) - e + t.charCodeAt(i),
            e &= e;
            return e
        }
...
function() {
    ...
    i = $("#choose-amount"),
    s = $("#choose-result");
    e.before('<div class="choose-amount fl"></div>'),
    $(".choose-amount").append(t),
    $(".btn-reduce").html("-"),
    $(".btn-add").html("+"),
    i.remove(),
    s.remove()
...
function(t) { (t.itemShopJsona && t.itemShopJsona.searchLink || t.itemShopJsonb && t.itemShopJsonb.shopCategory) && ($("#sp-category").after('<div id="browse-browse-pop" class="m m2 hide related-buy"><div class="mt"><h2>\u770b\u4e86\u53c8\u770b</h2></div><div class="mc"></div></div>'), new Grecommend(G.sku, 902029, readCookie("ipLoc-djd"), $("#browse-browse-pop .mc")))
} (window);